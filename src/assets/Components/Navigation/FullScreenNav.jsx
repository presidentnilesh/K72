...
const FullScreenNav = () => {
  ...
  return (
    <div ref={fullScreenRef} id='fullscreennav' className='h-screen hidden bg-red-500 text-white overflow-hidden w-full z-50 absolute'>
      <div ref={fullNavLinksRef} className='relative'>
        <div className='navLink flex items-start h-20 mt-1 w-full justify-between'>
          ...
          <div onClick={()=>{
          setNavOpen(false)
          }} className='h-30 w-30 cursor-pointer relative'>
